 ...
 *      ②被观察者（target）被观察对象发生了某种变化（如图中的SomeChange），从容器中得到所有注册过的观察者，将变化通知观察者。
 ...
 *
 * 案例：中学课堂；后排的同学有的在睡觉，有的在看课外书，但他们都担心两点：一、老师走下讲台；二、班主任来查班；于是这些上课不认真的同学
 *       就委托另一位正常上课的同学，当老师走下讲台或班主任来查班的时候就通知他们。
 *      被观察者（target）： 老师、班主任
 *      观察者（Observer抽象）：睡觉、看课外书的同学
 *      通知者（Informer实际观察者）：被委托的正常听课的同学
 *
